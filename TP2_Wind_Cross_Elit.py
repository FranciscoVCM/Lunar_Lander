...
#Alterações: Crossover alterado para crossover aritmetico e elite size mudado para 3/5
...
def crossover(p1, p2):
    # crossover aritmetico, cada gene do filho é uma média ponderada dos genes dos pais, com um peso alpha aleatório entre 0 e 1
    child_genotype = []
    for g1, g2 in zip(p1['genotype'], p2['genotype']):
        alpha = random.random()
        novo_gene = alpha * g1 + (1.0 - alpha) * g2
        child_genotype.append(novo_gene)
