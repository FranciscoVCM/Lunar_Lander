...
#Alterações: Shape alterada para (nInputs, 24, nOutputs), ou seja, 24 neurónios na camada escondida em vez de 12, para dar mais poder de computação à rede, e consequentemente, mais capacidade de aprender a lidar com o vento.
...
nInputs = 8
nOutputs = 2
SHAPE = (nInputs,24,nOutputs) #Teste com 24 neurónios na camada escondida, em vez de 12
GENOTYPE_SIZE = 0
...
def evaluate(evaluationQueue, evaluatedQueue):
    ...
    while True:
        ...
        #serve para cancelar o fator sorte do vento, uma nova boa pode ter azar e apanhar um vento bue forte
        total_fitness = 0
        num_episodes = 3
